...
Caso o (módulo do) valor do fator de balanceamento atinja 2, as rotações simples ou duplas
...
precisa percorrer recursivamente por todas suas subárvores para descobrir suas alturas a cada
inserção ou remoção, a operação de balanceamento teria maior complexidade, com $O(n)$ no pior caso,
diminuindo a vantagem de se usar uma árvore auto-balanceada.
